  ...
  render() {
    return (
      <div className="main">
        <div>
          ...
          <div style={hidden}>
            <img
              ...
              src={this.state.colorful ? "black.svg" : "black.svg"}
              alt={`DSC Icon`}
            />
          </div>
          ...
          <div className="controls">
            ...
            <select defaultValue={this.state.naming_scheme} ref="naming_scheme" onChange={this.handleChange}>
              ...
              <option value="GFSC">GFSC</option>
              <option value="GameFactory Student Clubs">GameFactory Student Clubs</option>
            </select>
        ...
        <footer>
          Made with by <a href="https://twitter.com/BahriMelih" target="_blank" rel="noopener noreferrer">@melihbahri</a>
        </footer>
      </div>
    );
  }
